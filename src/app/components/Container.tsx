...
export default function Container({ price, name, description, image, tag, inHero, shadow, hasBorder, tabState }: ContainerProps) {
    return (
        <div className={`relative flex flex-col rounded-lg bg-white w-60 h-60 lg:w-100 lg:h-100 xl:w-120 xl:h-120 border-zinc-100 hover:shadow-md transition duration-400 ease shrink-0
            ${hasBorder && "border-1"}
            ${shadow && "shadow-xl shadow-zinc-200"}
            ${inHero && "scale-75 lg:scale-100 animate-fade-in"}
        `}>

    ...
    return (
        <div className="bg-white w-full h-screen flex flex-col">
            ...
            <div className="flex flex-1 flex-col lg:flex-row">
                <div className="flex flex-col flex-1/2 justify-center px-10 py-7 gap-7 text-center lg:text-left bg-radial-[at_80%_40%] from-indigo-50 to-white lg:bg-radial-[at_35%_75%] lg:from_indigo-50 lg:to-white">
                    <h1 className="font-bold text-4xl lg:text-6xl text-black animate-fade-in">Buy, rent, or sell your propery easily</h1>
                    <h3 className="font-normal text-lg text-black animate-fade-in">A great platform to buy, sell, or even rent your properties without any commisions.</h3>

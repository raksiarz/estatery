    ...
    return (
        <div className="bg-white w-full h-screen flex flex-col">
            ...
            <div className="flex flex-1 max-h-full flex-col lg:grid lg:grid-cols-2">
                <div className="flex flex-col justify-center h-full px-10 py-7 gap-7 lg:gap-12 text-center lg:pr-50 xl:pr-75 lg:text-left bg-radial-[at_80%_40%] from-indigo-50 to-white lg:bg-radial-[at_35%_75%] lg:from_indigo-50 lg:to-white">
                    ...
                    <div className="flex justify-center lg:justify-start gap-5 animate-fade-in">
                        ...
                        <div className="flex flex-col gap-2 mr-18 items-start justify-center">
                            ...
                            <p className="font-normal text-base lg:text-lg text-zinc-400">renters</p>
                        </div>
                        <div className="h-auto w-[3px] bg-zinc-300"></div>
                        <div className="flex flex-col gap-2 items-start justify-center">
                            <p className="font-bold text-3xl lg:text-4xl text-indigo-400">10k+</p>
                            <p className="font-normal text-base lg:text-lg text-zinc-400">properties</p>
                        </div>
                    </div>
                </div>

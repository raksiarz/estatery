...
export default function Footer() {
    return (
        <div className="w-full bg-white h-auto flex flex-col items-center px-6 py-4">
            ...
            <div className="flex flex-col w-full lg:flex-row lg:justify-between items-center gap-5">
                ...
                <div className="w-auto flex justify-center items-center gap-x-10 opacity-30">
                    <Image src={facebook} alt="facebook logo" className="w-5"/>
                    <Image src={instagram} alt="instagram logo" className="w-5"/>
                    <Image src={twitter} alt="twitter logo" className="w-5"/>
                    <Image src={linkedin} alt="linkedin logo" className="w-5"/>
                </div>
            </div>
        </div>
    )
